...
### modified for coculture format
def get_bright_points_per_R_coculture(XF, iR, medh, uRs,
...
def get_counts_per_fov(fov, XF_RNA,
    ...
    XF_RNA_b = get_bright_points_per_R_coculture(XF_RNA, iR, medh, uRs,th_h=th_h)
